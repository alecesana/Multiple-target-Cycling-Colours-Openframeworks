...
void ColourSfumatore::setup(int _hexcolour1, int _hexcolour2, int _hexcolour3, int _nobjects) { 
	...
	// colors we are cycling through


	c0.setHex(_hexcolour1,200); //cc
	c1.setHex(_hexcolour2,200); //cc
	c2.setHex(_hexcolour3,200); //cc

	//colourcube[0], colourcube[1], colourcube[2] = _hexcolour1;
